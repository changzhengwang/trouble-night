package com.shadow.websocket;

import com.alibaba.fastjson.JSON;
import com.shadow.entity.ChatText;
...
import static com.shadow.utils.WebSocketUtils.*;
...
public class ChatRoomServerEndpoint {
    ...
    public void openSession(@PathParam("username") String username, Session session) {
        ...
        chatText.setName(username);
        chatText.setMessage("12345678tgsrtnbarrrrrrrrrrrrrrrrrrrrrrrrrrrrrrserbsergbesrgaergbvserdfbvsrtdbfetdbgetbgaerg");
        String result = JSON.toJSONString(chatText);
        sendMessageAll(result);
    }
